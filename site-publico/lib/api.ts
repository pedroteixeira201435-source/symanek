...
export async function listApplications(): Promise<AdminApplication[]> {
  if (useSupabase()) {
    const { data, error } = await supabase!
      .from("applications")
      .select("id,reference,full_name,email,phone,programme_slug,mode,stage,amount_due,created_at")
  ...
  await wait(400);
  return [
    { id: "m1", reference: null, fullName: "Johanna Amukwa", email: "johanna@example.com", phone: "+264 81 000 0001", programmeSlug: "certificate-caregiving", mode: "full_time", stage: "submitted", amountDue: 0, createdAt: new Date().toISOString() },
    { id: "m2", reference: "SYM-2026-0042", fullName: "Gabriel Naruseb", email: "gabriel@example.com", phone: "+264 81 000 0002", programmeSlug: "certificate-ohs-level-4", mode: "full_time", stage: "approved", amountDue: 19670, createdAt: new Date().toISOString() },
    { id: "m3", reference: "SYM-2026-0043", fullName: "Maria Shikongo", email: "maria@example.com", phone: "+264 81 000 0003", programmeSlug: "certificate-caregiving", mode: "distance", stage: "enrolled", amountDue: 0, createdAt: new Date().toISOString() },
  ];
}
